        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div>
                                <form class="d-inline-block mr-1 search-form" temp-src="blog-template" temp-dest="blog-container" temp-url="all-blogs">
                                ...
                                <a href="<?=site_url('add-blog')?>" class="btn btn-sm btn-outline-primary">Add</a>
                            </div>
                    ...
                    <div class="card-body p-0">
                        <table class="table projects">
                               ...
                               <?php if(!empty($result['rows'])):?> 
                                <?php $i=1; foreach ($result['rows'] as $rows):?>
                                    <tr>
                                        ...
                                        <td>
                                            <img height="100px" width="100px" src="<?=site_url($rows['blog_img'])?>" alt=""
                                                class="img-fluid">
                                        </td>
                                        <td><?=$rows['date']?></td>
                                        <td>
                                        ...
                                        <td class="project-actions">
                                            <a class="btn btn-outline-primary btn-sm" href="<?=site_url('view-blog')?>/<?=$rows['blog_id']?>" >
                                                <i class="fas fa-folder">
                                                </i>
                                                
                                            </a>
                                            <a class="btn btn-outline-info btn-sm" href="<?=site_url('edit-blog')?>/<?=$rows['blog_id']?>" >
                                                <i class="fas fa-pencil-alt">
                                                </i>
                                            </a>
                                            <a blogId="<?=$rows['blog_id']?>" class="btn btn-outline-danger btn-sm delete-blog" href="#">
                            ...
                            <script type="text/x-handlebars-template" id="blog-template">        
                              {{#if result.rows}}
                                {{#each result.rows}}
                                  <tr>                                 
                                     ...
                                     <td>{{blog_title}}</td>
                                        <td>
                                           <img height="100px" width="100px" src="<?=site_url()?>/{{blog_img}}" alt=""
                                                class="img-fluid">
                                        </td>
                                        <td>{{date}}</td>
                                        <td>
                                        ...
                                        <td class="project-actions">
                                            ...
                                            <a blogId="{{blog_id}}" class="btn btn-outline-danger btn-sm delete-blog" href="#">
                                                <i class="fas fa-trash">
                                                </i>
                                            </a>
                                        </td>
                ...
                <div class="limit-option">
                  <select class="form-control round input-sm per-page btn-sm" temp-src="blog-template" temp-dest="blog-container" temp-url="all-blogs">
                ...
                <div class="">
                  ...
                  <ul class="pager pager-round d-inline-block pl-2">
                    <li class="disabled">
                      <a href="#" class="page-link btn-sm  btn-prev" temp-src="blog-template" temp-dest="blog-container" temp-url="all-blogs"><i class="fas fa-angle-double-left"></i></a>
                    </li>
                    <li class="page-item active"  id="pageCountContainer">
                      <a class="page-link btn-sm" href="#">1</a>
                    </li>
                    <li>
                      <a href="#" class="page-link btn-sm  btn-next" temp-src="blog-template" temp-dest="blog-container" temp-url="all-blogs"> <i class="fas fa-angle-double-right"></i></a>
                    </li>
                  </ul>  
                </div>
...
<!-- ///////////////////////////////////////////////////////////////////// -->
    ...
    <!-- ./wrapper -->
     ...
     <script type="text/javascript">
        var src   = 'blog-template';
        var dest  = 'blog-container';
        var url   = 'all-blogs';      
        ...
        $('body').on('click','.delete-blog',function(e){
            confirmBoxActiveInactive('delete-blog',$(this).attr('blogId'),'Delete','danger','danger')
        })
    </script>    
