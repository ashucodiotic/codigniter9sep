                        ...
                        <div class="card card-primary">
                            ...
                            <form class="add-news row" > 
                                ...
                                mt-4 col-md-12">
                                    ...
                                    <button type="button" class="btn btn-info reset-form" form="add-news" >Reset</button>
                                </div>
                            </form>    
                            </div>
                            <!-- /.card-body -->
