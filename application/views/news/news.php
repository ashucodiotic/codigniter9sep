        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <div>
                                <form class="d-inline-block mr-1 search-form" temp-src="news-template" temp-dest="news-container" temp-url="all-news">
                                ...
                                <a href="<?=site_url('add-news')?>" class="btn btn-sm btn-outline-primary">Add</a>
                            </div>
                               ...
                               <?php if(!empty($result['rows'])):?> 
                                <?php $i=1; foreach ($result['rows'] as $rows):?>
                                    <tr>
                                        ...
                                        <td>
                                            <img height="100px" width="100px" src="<?=site_url($rows['image'])?>" alt=""
                                                class="img-fluid">
                                        </td>
                                        <td><?=$rows['news_text']?></td>
                                        <td><?=$rows['news_date']?></td>
                                        <td class="project-actions">
                                            <a class="btn btn-outline-primary btn-sm" href="<?=site_url('view-news')?>/<?=$rows['news_id']?>" >
                                                <i class="fas fa-folder">
                                                </i>
                                                
                                            </a>
                                            <a class="btn btn-outline-info btn-sm" href="<?=site_url('edit-news')?>/<?=$rows['news_id']?>" >
                                                <i class="fas fa-pencil-alt">
                                                </i>
                                            </a>
                                            <a newsId="<?=$rows['news_id']?>" class="btn btn-outline-danger btn-sm delete-news" href="#">
                                ...
                                {{#each result.rows}}
                                  <tr>                                 
                                     ...
                                     <td>{{news_title}}</td>
                                        ...
                                        <td>{{news_date}}</td>
                                        <td class="project-actions">
                                            <a class="btn btn-outline-primary btn-sm" href="<?=site_url('view-news')?>/{{news_id}}" >
                                                <i class="fas fa-folder">
                                                </i>
                                                
                                            </a>
                                            <a class="btn btn-outline-info btn-sm" href="<?=site_url('edit-news')?>/{{news_id}}" >
                                                <i class="fas fa-pencil-alt">
                                                </i>
                                            </a>
                                            <a newsId="{{news_id}}" class="btn btn-outline-danger btn-sm delete-news" href="#">
                                                <i class="fas fa-trash">
                                                </i>
                                            </a>
                                        </td>
                ...
                <div class="limit-option">
                  <select class="form-control round input-sm per-page btn-sm" temp-src="news-template" temp-dest="news-container" temp-url="all-news">
                ...
                <div class="">
                  ...
                  <ul class="pager pager-round d-inline-block pl-2">
                    <li class="disabled">
                      <a href="#" class="page-link btn-sm  btn-prev" temp-src="news-template" temp-dest="news-container" temp-url="all-news"><i class="fas fa-angle-double-left"></i></a>
                    </li>
                    <li class="page-item active"  id="pageCountContainer">
                      <a class="page-link btn-sm" href="#">1</a>
                    </li>
                    <li>
                      <a href="#" class="page-link btn-sm  btn-next" temp-src="news-template" temp-dest="news-container" temp-url="all-news"> <i class="fas fa-angle-double-right"></i></a>
                    </li>
                  </ul>  
                </div>
...
<!-- ///////////////////////////////////////////////////////////////////// -->
    ...
    <!-- ./wrapper -->
     ...
     <script type="text/javascript">
        var src   = 'news-template';
        var dest  = 'news-container';
        var url   = 'all-news';      
        ...
        $('body').on('click','.delete-news',function(e){
            confirmBoxActiveInactive('delete-news',$(this).attr('newsId'),'Delete','danger','danger')
        })
    </script>    
